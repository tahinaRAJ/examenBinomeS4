...
<div class="app-grid-2">
        ...
        <form action="<?= site_url('client/retrait') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="montant" name="montant" min="1" step="1"
                       placeholder="Ex. 20000" required autofocus>
            </div>
    ...
    <div class="app-card">
        ...
        <p class="muted">Le retrait est tarifable : des <strong>frais</strong>
        s'ajoutent au montant retiré, selon la tranche dans laquelle il tombe.
        Votre solde doit couvrir le montant <em>et</em> les frais.</p>
    </div>
</div>
